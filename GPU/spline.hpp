...
template<class _V, class _C, int _M, int _K> class spline_1D {
  public:
    ...
    __host__ __device__ _V operator()(const _C & x) const;
...
template<class _V, class _C, int _MX, int _MY, int _KX, int _KY> class spline_2D {
  public:
    ...
    __host__ __device__ _V operator()(const _C & x, const _C & y) const;
...
template<class _V, class _C, int _MX, int _MY, int _MZ, int _KX, int _KY, int _KZ> class spline_3D {
  public:
    ...
    __host__ __device__ _V operator()(const _C & x, const _C & y, const _C & z) const;
...
template<class _C, int _M, int _K> inline __host__ __device__ int find_span(const _C & x);
template<class _C, int _M, int _K> __host__ __device__ void evaluate_basis(_C basis[_M], const _C & x, int ell);
